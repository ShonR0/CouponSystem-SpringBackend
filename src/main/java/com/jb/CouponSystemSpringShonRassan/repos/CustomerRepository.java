...
public interface CustomerRepository extends JpaRepository<Customer, Integer> {
    ...
    boolean existsByEmailAndPasswordAndUserType(String email, String password, UserType userType);
...
//    @Query(value = "select * from customers_coupons where customer_id = ?", nativeQuery = true)
    ...
    Customer findTop1ByEmailAndPassword(String email, String password);
