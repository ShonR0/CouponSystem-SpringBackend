...
//        Coupon updateCoupon = companyService.getSingleLoggedCompanyCoupon(1, 1);
//        updateCoupon.setAmount(100);
//        companyService.updateCoupon(1,1, updateCoupon);
...
//        companyService.deleteCoupon(11, cocaCola.getId());
...
//        companyService.getAllCompanyCouponsByCategory(1, Category.FOOD)
...
//        companyService.getAllCompanyCouponsByMaxPrice(cocaCola.getId(), 4).forEach(System.out::println);
//
...
//        customerService.purchaseCoupon(purchCoupon1.getId(), cu1.getId());
//
//        PrintUtils.title("Get logged customer coupons");
//        int id = cu1.getId();
//        customerService.getAllLoggedCustomerCoupons(id).forEach(System.out::println);
//
